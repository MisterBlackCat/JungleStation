/proc/possess(obj/O in world)
	...
	O.AddElement(/datum/element/weather_listener, /datum/weather/toxic_rain, ZTRAIT_TOXICSTORM, GLOB.toxic_storm_sounds)
...
/proc/release()
	...
	usr.control_object.RemoveElement(/datum/element/weather_listener, /datum/weather/toxic_rain, ZTRAIT_TOXICSTORM, GLOB.toxic_storm_sounds)
