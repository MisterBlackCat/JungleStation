/datum/map_generator/cave_generator/jungle
	weighted_open_turf_types = list(/turf/open/misc/dirt/jungle/junglestation = 19, /turf/open/misc/dirt/jungle/junglestation/dark = 1)
...
/datum/map_generator/cave_generator/jungle/surface/noruins //use this for when you don't want ruins to spawn in a certain area

/datum/map_generator/cave_generator/jungle/deep
	weighted_closed_turf_types = list(/turf/closed/mineral/random/jungle/underground = 1)
