...
/obj/structure/closet/body_bag/environmental
	...
	var/list/weather_protection = list(TRAIT_TOXICSTORM_IMMUNE, TRAIT_ASHSTORM_IMMUNE, TRAIT_RADSTORM_IMMUNE, TRAIT_SNOWSTORM_IMMUNE, TRAIT_VOIDSTORM_IMMUNE) // Does not protect against lava or the The Floor Is Lava spell.
